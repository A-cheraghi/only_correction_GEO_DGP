...
class SetCriterion(nn.Module):
    ...
    def forward(self, outputs, targets, mask_dict=None):
        ...
        # =========================================================================
        # ۱. محاسبه Loss اصلی و نهایی (خروجی بلوک اصلاحی شما)
        # =========================================================================
        outputs_without_aux = {k: v for k, v in outputs.items() if k != 'aux_outputs' and k != 'inter_outputs'}
        ...
        # =========================================================================
        # نکته مهم: حلقه‌های مربوط به inter_outputs و aux_outputs کلاً پاک شدند
        # تا Matcher روی CPU برای لایه‌های میانی اجرا نشود و سرعت بالا برود.
        # =========================================================================
